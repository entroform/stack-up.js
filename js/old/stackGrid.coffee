...
(($) ->
  ...
  $.fn.stackGrid = ( blocks, options ) ->
    ...
    $window.on 'load resize stackgrid', ->
      window.requestAnimationFrame resizeHandler
    $window.on 'load resize stackgrid-initialize', ->
      window.requestAnimationFrame initialize

    grid.container.self.on 'stackgrid-update', ->
      window.requestAnimationFrame updateHandler
    grid.container.self.on 'stackgrid-initialize', ->
      window.requestAnimationFrame initialize
